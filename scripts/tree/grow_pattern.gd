...
@export var use_auxin: bool = false
@export var auxin_source_strength: float = 1.0
@export var auxin_decay: float = 0.68
@export var thickness_falloff: float = 0.75
@export var use_pipe_taper: bool = true
@export var pipe_exponent: float = 2.0
@export var segment_taper_power: float = 1.12
@export var terminal_taper_ratio: float = 0.58
